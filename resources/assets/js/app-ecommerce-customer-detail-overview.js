...
$(function () {
  ...
  var dt_Client_order = $('.datatables-Client-order'),
  ...
  // orders datatable
  if (dt_Client_order.length) {
    var dt_order = dt_Client_order.DataTable({
      ajax: assetsPath + 'json/ecommerce-Client-order.json', // JSON file to add data
      columns: [
