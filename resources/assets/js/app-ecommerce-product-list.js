        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var categoryBadgeObj = {
              Household:
                '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-warning me-2"><i class="mdi mdi-home-outline-outline"></i></span>',
              Office:
