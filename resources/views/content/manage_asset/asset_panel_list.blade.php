                        ...
                        <tbody class="text-black fw-semibold fs-7">
                            @foreach ($assets as $asset)
                                <tr>
                                    ...
                                    <td>
                                        <label class="text-black fw-medium fs-7"
                                            title="{{ $asset->description }}">{{ Str::limit($asset->description ?: '-', 20) }}</label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-start flex-column">
                                            <label
                                                class="text-black fw-medium fs-7">{{ $asset->plant->name ?? 'N/A' }}</label>
                                            <label
                                                class="text-dark fw-medium fs-8">{{ $asset->sector->name ?? 'N/A' }}</label>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="text-end">
                                            <a href="#" class="btn btn-icon btn-sm me-2 view-asset-btn"
                                                data-id="{{ $asset->id }}">
            ...
            <div class="asset-container">
                <div class="asset-list-panel">
                    <div class="panel-header">
                        <input type="text" id="assetSidebarSearch" placeholder="Search Tag, Plant, Size..."
                            class="form-control">
                            ...
                            <div class="asset-item asset-sidebar-item" data-id="{{ $asset->id }}">
                                <div>
                                    <div class="asset-title">
                                        <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Asset Tag"
                                            class="fs-7 text-black fw-medium">{{ $asset->tag_number }}</span>
                                    </div>
                                    <div class="asset-meta">
                                        <span class="tag" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                            title="Plant">{{ $asset->plant->name ?? 'N/A' }}</span>
                                    </div>
                                </div>
                                <div class="asset-size">
                                    <span class="fs-7">{{ $asset->actual_size ?: '-' }} X
                                        {{ $asset->pressure_class ?: '-' }}</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
                            ...
                            <div>
                                ...
                                <div class="detail-card">
                                    ...
                                    <div class="d-flex flex-column gap-1">
                                        <span class="text-dark fw-semibold fs-6">
                                            <i
                                                class="mdi mdi-navigation-variant-outline text-primary cursor-pointer"></i>Geo-Location
                                        </span>
                ...
                <div class="modal-body py-5 px-10 px-xl-20">
                    <div class="row scroll-y" style="max-height: 550px;">
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Asset Type/Tag<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="add_tag_number" class="form-control"
                                placeholder="Enter Asset Type/Tag" />
                            <div class="text-danger error-tag_number"></div>
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Customer Asset Name<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="add_asset_name" class="form-control"
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" id="add_work_center" class="form-control"
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" id="add_longitude" class="form-control"
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" value="Scaffolding"
                                    name="add_scaff_crane" />
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" value="Scaffolding + Crane"
                                    name="add_scaff_crane" />
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body py-5 px-10 px-xl-20">
                    ...
                    <div class="row scroll-y" style="max-height: 550px;">
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Asset Type/Tag<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="edit_tag_number" class="form-control"
                                placeholder="Enter Asset Type/Tag" />
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Customer Asset Name<span
                                    class="text-danger">*</span></label>
                            <input type="text" id="edit_asset_name" class="form-control"
                                placeholder="Enter Asset Name" />
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Client</label>
                        ...
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Valve Type</label>
                            <input type="text" id="edit_valve_type" class="form-control"
                                placeholder="Enter Valve Type" />
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Actual Size</label>
                            <input type="text" id="edit_actual_size" class="form-control"
                                placeholder="Enter Actual Size" />
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Estimated Size</label>
                            <input type="text" id="edit_estimated_size" class="form-control"
                                placeholder="Enter Estimated Size" />
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Pressure Class</label>
                            <input type="text" id="edit_pressure_class" class="form-control"
                                placeholder="Enter Pressure Class" />
                        </div>
                        <hr class="my-1">
                        <div class="col-lg-12 mb-2">
                        ...
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Work Center</label>
                            <input type="text" id="edit_work_center" class="form-control"
                                placeholder="Enter Work Center" />
                        </div>
                        <div class="col-lg-6 mb-3">
                            <label class="text-black mb-1 fs-7 fw-semibold">Latitude</label>
                ...
                <div class="modal-footer pt-5">
                    <div class="d-flex justify-content-end align-items-center">
                        <button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-primary" id="update_asset_btn">Update Customer
                            Asset</button>
                    </div>
                </div>
                <!--end::Modal body-->
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", "#edit_asset_btn", function() {
                ...
                $.get("/assets/show/" + currentAssetId, function(res) {
                    ...
                    if (a.scaff_crane) {
                        $("input[name='edit_scaff_crane'][value='" + a.scaff_crane + "']").prop(
                            'checked', true);
                    }
