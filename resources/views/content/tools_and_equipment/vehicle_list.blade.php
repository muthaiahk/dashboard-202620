            ...
            <div class="d-flex justify-content-end align-items-center mb-2 gap-2">
                <div class="searchBar" style="position: relative; width: 300px;">
                    <input class="form-control" type="text" name="searchQueryInput"
                        placeholder="Search Vehicle " value=""
                ...
                <a href="javascript:;" class="btn btn-sm fw-bold text-white btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_vehicle">
        ...
        <div class="row g-3">
                ...
                <div class="p-3 rounded border d-flex flex-column bg-white">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex gap-2 align-items-center">  
                            <label class="text-black fw-semibold fs-6">CRN-001</label>
                        </div>
                        <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Update"><i class="mdi mdi-pencil-outline  text-secondary me-1 cursor-pointer"  data-bs-toggle="modal" data-bs-target="#kt_modal_update_vehicle"></i></span>
                    </div>
                    <hr class="my-3">
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <label class="badge bg-label-danger text-danger fs-7 fw-semibold">Liebherr</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                            ...
                            <label class="text-black fs-7 fw-semibold">LTM 1100-5.2</label>
                        </div>
                    </div>
                    <hr class="my-3">
                    <div class="row">
            ...
            <div class="col-lg-3">
                <div class="p-3 rounded border d-flex flex-column bg-white">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex gap-2 align-items-center">  
                            <label class="text-black fw-semibold fs-6">CRN-002</label>
                        </div>
                        <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Update"><i class="mdi mdi-pencil-outline  text-secondary me-1 cursor-pointer"  data-bs-toggle="modal" data-bs-target="#kt_modal_update_vehicle"></i></span>
                    </div>
                    <hr class="my-3">
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <label class="text-black fs-7 fw-semibold">QA-CR-7845</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <span class="mdi mdi-shield-outline text-secondary"></span>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <label class="text-black fs-7 fw-semibold">LTM 1250-5.1</label>
                        </div>
                    </div>
                    <hr class="my-3">
                    <div class="row">
            ...
            <div class="col-lg-3">
                <div class="p-3 rounded border d-flex flex-column bg-white">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex gap-2 align-items-center">  
                            <label class="text-black fw-semibold fs-6">TRL-011</label>
                        </div>
                        <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Update"><i class="mdi mdi-pencil-outline  text-secondary me-1 cursor-pointer"  data-bs-toggle="modal" data-bs-target="#kt_modal_update_vehicle"></i></span>
                    </div>
                    <hr class="my-3">
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <label class="text-black fs-7 fw-semibold">QA-TL-2291</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <span class="mdi mdi-shield-outline text-secondary"></span>
                            ...
                            <label class="badge bg-label-danger text-danger fs-7 fw-semibold">Volvo</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <span class="mdi mdi-office-building-outline text-secondary"></span>
                            ...
                            <label class="text-black fs-7 fw-semibold">FH16 750</label>
                        </div>
                    </div>
                    <hr class="my-3">
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-center gap-1">                            
                            <span class="mdi mdi-refresh fw-semibold text-primary"></span>
            ...
            <div class="col-lg-3">
                <div class="p-3 rounded border d-flex flex-column bg-white">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex gap-2 align-items-center">  
                            <label class="text-black fw-semibold fs-6">TRK-021</label>
                        </div>
                        <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Update"><i class="mdi mdi-pencil-outline  text-secondary me-1 cursor-pointer"  data-bs-toggle="modal" data-bs-target="#kt_modal_update_vehicle"></i></span>
                    </div>
                    <hr class="my-3">
                    <div class="d-flex flex-column gap-2">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <label class="text-black fs-7 fw-semibold">QA-HV-6623</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <span class="mdi mdi-shield-outline text-secondary"></span>
                            ...
                            <label class="badge bg-label-danger text-danger fs-7 fw-semibold">MAN</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                <span class="mdi mdi-office-building-outline text-secondary"></span>
                            ...
                            <label class="text-black fs-7 fw-semibold">TGS 40.440</label>
                        </div>
                    </div>
                    <hr class="my-3">
                    <div class="row">
                        <div class="col-lg-12 d-flex align-items-center gap-1">                            
                            <span class="mdi mdi-information-outline fw-semibold text-warning"></span>
                            <label class="text-warning fs-7 fw-semibold ">Maintanence</label>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="modal-content rounded">
                    ...
                    <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Vehicle Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Vehicle Name" />
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Brand<span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Registered Number<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Registered Number" />
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Engine Number<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Engine Number" />
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Chasis Number<span class="text-danger">*</span></label>
        ...
        <div class="modal-footer pt-5">
          <div class="d-flex justify-content-end align-items-center">
            ...
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Create Vehicle</button>
          </div>
        </div>
        <!--end::Modal body-->
      </div>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content rounded">
        ...
        <div class="modal-footer pt-5">
          <div class="d-flex justify-content-end align-items-center">
            <button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Update Vehicle</button>
          </div>
        </div>
        <!--end::Modal body-->
      </div>
