...
<footer class="landing-footer">
  <div class="footer-top position-relative overflow-hidden">
    <img src="{{asset('')}}" alt="footer bg" class="footer-bg banner-bg-img" />
      ...
      <div class="row gx-0 gy-4 g-md-5">
        <div class="col-lg-5">
          <a href="{{url('front-pages/landing')}}" class="app-brand-link mb-4">
            ...
            <span class="app-brand-text demo footer-link fw-bold">{{config('variables.templateName')}}</span>
          </a>
        ...
        <div class="col-lg-3 col-md-4">
          ...
          <a href="javascript:;" class="d-block footer-link mb-3 pb-2"><img src="{{asset('')}}" alt="apple icon" /></a>
          <a href="javascript:;" class="d-block footer-link"><img src="{{asset('')}}" alt="google play icon" /></a>
        </div>
      </div>
    </div>
  </div>
  <div class="footer-bottom py-3">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      ...
      <div>
        <a href="{{config('variables.githubUrl')}}" class="footer-link me-2" target="_blank"><i class="mdi mdi-github"></i></a>
