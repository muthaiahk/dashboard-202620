/**
 * App eCommerce Client Detail - Delete Client Script
 */
'use strict';
...
(function () {
  ...
  if (deleteClient) {
    deleteClient.onclick = function () {
      Swal.fire({
        title: 'Are you sure?',
        text: "You won't be able to revert Client!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: 'Yes, Delete Client!',
        customClass: {
          confirmButton: 'btn btn-primary me-2 mt-2 mt-sm-0 waves-effect waves-light',
          cancelButton: 'btn btn-outline-secondary mt-2 mt-sm-0 waves-effect waves-light'
        },
