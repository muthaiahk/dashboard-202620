    ...
    <div class="card">
      <div class="card-header pb-1 mb-0 d-flex align-items-start justify-content-between gap-5">
        ...
        <div class="d-flex justify-content-end align-items-center gap-2">
          ...
          @if (auth()->user()->hasPermission('Room', 'is_create'))
                      ...
                      <tr>
                        ...
                        <td>
                          <label class="switch switch-square">
                            <input type="checkbox" class="switch-input" {{ isset($list->status) && $list->status == 0 ? 'checked' : '' }} onchange="statusChange('{{ $list->id }}', this.checked)" {{ auth()->user()->hasPermission('Room', 'is_update') ? '' : 'disabled' }} />
                        ...
                        <td>
                          <span class="text-end">
                            @if (auth()->user()->hasPermission('Room', 'is_update'))
                            ...
                            @endif
                            @if (auth()->user()->hasPermission('Room', 'is_delete'))
