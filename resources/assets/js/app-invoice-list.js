        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" data-bs-toggle="tooltip" class="text-body delete-record" data-bs-placement="top" title="Delete Invoice"><i class="mdi mdi-trash-can-outline mdi-20px mx-1"></i></a>' +
              '<a href="' +
              baseUrl +
