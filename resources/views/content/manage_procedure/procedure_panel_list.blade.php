...
@section('content')
            ...
            <div class="asset-container">
                <div class="asset-list-panel">
                    <div class="panel-header">
                        <input type="text" placeholder="Search Procedure, Asset, Work Category, ..."
                            class="form-control">
                    </div>
                    <div class="asset-list">
                        @foreach ($procedures as $proc)
                            <div class="asset-item procedure-sidebar-item {{ $loop->first ? 'active' : '' }}"
                                data-id="{{ $proc->id }}">
                                <div class="d-flex align-items-center justify-content-between gap-5">
                                    ...
                                    <div class="asset-size">
                                        <span class="fs-8 bg-label-dark badge rounded" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom"
                                            title="Asset Type">{{ $proc->asset_type ?: '-' }}</span>
                                    </div>
                                </div>
                                <div class="asset-meta">
                                    <span class="tag fs-7" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="Work Category">{{ $proc->work_category ?: '-' }}</span>
                                </div>
                                <div>
                                    <span
                                        class="text-secondary fw-semibold fs-7">{{ Str::limit($proc->description, 80) }}</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-start gap-3">
                                    ...
                                    <span
                                        class="text-dark fw-semibold fs-8">{{ $proc->created_at ? $proc->created_at->format('d-M-Y') : '-' }}</span>
                                </div>
                            </div>
                        @endforeach
                        @if ($procedures->isEmpty())
                            <div class="text-center py-5 text-muted">No procedures found. Click "Add Procedure" to create
                                one.</div>
                        @endif
                    </div>
                </div>
                                    ...
                                    <div class="accordion-item border">
                                        <h2 class="accordion-header" id="headingProcedure">
                                            <button class="accordion-button collapsed d-flex align-items-center gap-2"
                                                type="button" data-bs-toggle="collapse" data-bs-target="#collapseProcedure"
                                        ...
                                        <div id="collapseProcedure" class="accordion-collapse"
                                            ...
                                            <div class="accordion-body p-2">
                                                <div class="detail-card mb-2" id="sop_detail_steps">
                                                    <div class="text-muted text-center py-3">No procedure steps added yet.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item border">
                                        <h2 class="accordion-header" id="headingPreChecklist">
                                            <button class="accordion-button collapsed d-flex align-items-center gap-2"
                                                ...
                                                data-bs-target="#collapsePreChecklist" aria-expanded="false"
                                                aria-controls="collapsePreChecklist">
                                                <i class="mdi mdi-page-previous-outline text-dark fs-4 me-2"></i>
                                ...
                                <div class="accordion mb-3" id="postChecklistAccordion">
                                    <div class="accordion-item border">
                                        <h2 class="accordion-header" id="headingPostChecklist">
                                            <button class="accordion-button collapsed d-flex align-items-center gap-2"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapsePostChecklist" aria-expanded="false"
                                                aria-controls="collapsePostChecklist">
                                                <i class="mdi mdi-page-previous-outline text-dark fs-4 me-2"></i>
                                                <span class="fs-5 text-black">Post-Checklist</span>
                                            </button>
                                        </h2>
                                        <div id="collapsePostChecklist" class="accordion-collapse collapse"
                                            aria-labelledby="headingPostChecklist"
                                            data-bs-parent="#postChecklistAccordion">
                                            <div class="accordion-body p-2">
                        ...
                        <div class="detail-header bg-gray-100">
                            ...
                            <div class="detail-desc">
                                <div class="d-flex align-items-center justify-content-end gap-2">
                                    ...
                                    <button id="cancel-sop-btn"
                                        class="btn btn-primary-outline btn-sm border border-primary text-primary">Cancel</button>
                                </div>
                            </div>
                        </div>
                        <div class="detail-body row">
                            <div class="col-lg-4 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Title<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Procedure Title"
                                    value="" id="procedure-title" required>
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Procedure Code</label>
                                <input type="text" class="form-control" placeholder="e.g. POC/001" value=""
                                    id="procedure-code">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Asset Type<span
                                        class="text-danger">*</span></label>
                                <select class="form-select select3" id="asset-type" required>
                            ...
                            <div class="col-lg-4 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Work Category<span
                                        class="text-danger">*</span></label>
                                <select class="form-select select3" id="work-category" required>
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="text-black mb-1 fs-7 fw-semibold">Description<span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control mb-3" id="procedure-description" required></textarea>
                            </div>
                                            ...
                                            <div class="accordion-body p-2">
                                                <div id="preChecklistContainer">
                                                    <div class="d-flex align-items-center gap-2 mb-2 checklist-row">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger-outline border border-danger deleteRow">
                            ...
                            <div class="col-lg-12 mb-3 bg-gray-100 rounded border border-gray-300 p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input rounded w-25px h-25px" type="checkbox"
                                            id="post-checklist-toggle">
                                        <label class="form-check-label text-black fw-semibold"
                                            for="post-checklist-toggle">
                                            Post-Checklist
                                        </label>
                                    </div>
                        ...
                        <div class="detail-body row">
                            ...
                            <div class="col-lg-12 mb-3 bg-gray-100 rounded border border-gray-300 p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input rounded w-25px h-25px" type="checkbox"
                                            id="edit-pre-checklist-toggle">
                                        <label class="form-check-label text-black fw-semibold"
                                            for="edit-pre-checklist-toggle">
                                            Pre-Checklist
                                        </label>
                                        <a href="javascript:;" class="" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_require_tools">
                            ...
                            <div class="col-lg-12 mb-3 bg-gray-100 rounded border border-gray-300 p-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input rounded w-25px h-25px" type="checkbox"
                                            id="edit-post-checklist-toggle">
                                        <label class="form-check-label text-black fw-semibold"
                                            for="edit-post-checklist-toggle">
                                            Post-Checklist
                                        </label>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-2 d-flex align-items-center justify-content-end">
                            <div class="detail-spec">
                                <input id="selectAllTools" class="form-check-input rounded w-20px h-20px"
                                    type="checkbox" />
    ...
    <script>
        $(document).ready(function() {
            ...
            initChecklist("edit-pre-checklist-toggle", "edit-preAccordian", "edit-addPreChecklist",
                "edit-preChecklistContainer");
            initChecklist("edit-post-checklist-toggle", "edit-postAccordian", "edit-addChecklist",
                "edit-checklistContainer");
            ...
            editAddSectionBtns.forEach(btn => {
                btn.addEventListener("click", function() {
                    let section = document.createElement("div");
                    section.className =
                        "border rounded p-3 mb-3 procedure-section bg-label-secondary";
                    section.innerHTML = `
                <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            if (selectAll) {
                selectAll.addEventListener("change", function() {
                    tools.forEach(tool => {
                        tool.checked = selectAll.checked;
                    });
                });
                tools.forEach(tool => {
                    tool.addEventListener("change", function() {
                        selectAll.checked = document.querySelectorAll(".tool-checkbox:checked")
                            .length === tools.length;
                    });
                });
            }
            ...
            document.addEventListener("click", function(e) {
                if (e.target.closest(".editProcedureBtn")) {
                    if (!currentProcedureId) {
                        showToast('warning', "Select a procedure first");
                        return;
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            if (res.status && res.data) {
                                ...
                                // Pre checklist
                                let preContainer = document.getElementById(
                                    'edit-preChecklistContainer');
                                preContainer.innerHTML = '';
                                if (d.pre_checklist && d.pre_checklist.length > 0) {
                                    document.getElementById('edit-pre-checklist-toggle')
                                        .checked = true;
                                    document.getElementById('edit-preAccordian').classList
                                        .remove('d-none');
                                    document.getElementById('edit-addPreChecklist').classList
                                        .remove('d-none');
                                    d.pre_checklist.forEach(item => {
                                        let row = document.createElement("div");
                                        row.className =
                                            "d-flex align-items-center gap-2 mb-2 checklist-row";
                                ...
                                if (d.post_checklist && d.post_checklist.length > 0) {
                                    document.getElementById('edit-post-checklist-toggle')
                                        .checked = true;
                                    document.getElementById('edit-postAccordian').classList
                                        .remove('d-none');
                                    document.getElementById('edit-addChecklist').classList
                                        .remove('d-none');
            ...
            document.querySelectorAll('.procedure-sidebar-item').forEach(item => {
                item.addEventListener('click', function() {
                    ...
                    // highlight
                    document.querySelectorAll('.procedure-sidebar-item').forEach(i => i.classList
                        .remove('active'));
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status && res.data) {
                            ...
                            $('#sop_detail_created_by').text(d.created_at ? new Date(d.created_at)
                                .toLocaleDateString() : '-');
                            ...
                            if (d.steps && d.steps.length > 0) {
                                d.steps.forEach(section => {
                                    stepsContainer.innerHTML +=
                                        `<div class="detail-spec"><span class="text-dark fw-bold fs-6">${section.title || ''}</span></div>`;
                                    if (section.items) {
                                        section.items.forEach(item => {
            ...
            function collectFormData(prefix) {
                ...
                let preChecklist = [];
                document.querySelectorAll('#' + preChecklistId + ' .checklist-row input[type="text"]').forEach(
                    inp => {
                ...
                let postChecklist = [];
                document.querySelectorAll('#' + postChecklistId + ' .checklist-row input[type="text"]').forEach(
                    inp => {
                ...
                saveSopBtn.addEventListener('click', function() {
                    try {
                        ...
                        if (!data.title || data.title.trim() === '') {
                            showToast('error', 'Please enter a Procedure Title');
                            return;
                        }

                        if (!data.asset_type || data.asset_type.trim() === '') {
                            showToast('error', 'Please select an Asset Type');
                            return;
                        }

                        saveSopBtn.disabled = true;
                        saveSopBtn.innerHTML =
            ...
            if (updateSopBtn) {
                updateSopBtn.addEventListener('click', function() {
                    try {
                        if (!currentProcedureId) {
                            showToast('error', 'No procedure selected');
                            return;
                        }
                        ...
                        if (!data.asset_type || data.asset_type.trim() === '') {
                            showToast('error', 'Please select an Asset Type');
                            $("#edit-asset_type").focus();
                            return;
                        }

                        updateSopBtn.disabled = true;
                        updateSopBtn.innerHTML =
