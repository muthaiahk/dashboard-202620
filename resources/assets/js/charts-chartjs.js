...
(function () {
  ...
  if (isDarkStyle) {
    ...
    labelColor = config.colors_dark.headingColor;
    legendColor = config.colors_dark.bodyColor;
    borderColor = config.colors_dark.borderColor;
  } else {
    cardColor = config.colors.cardColor;
    headingColor = config.colors.headingColor;
    labelColor = config.colors.headingColor;
    ...
    const barChartVar = new Chart(barChart, {
      ...
      data: {
        labels: [ 
          ...
          'AI Agricultural Systems',
          'Animal Foot Print Prediction',
          'Coastal Ecosystems and Biodiversity',
          'Multicultural Societies'
        ],
        datasets: [
          {
            data: [90,80,75,83,55,66,90,93,55,77,92,88,69],
