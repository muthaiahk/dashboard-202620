    ...
    <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto p-3 p-lg-0">
        ...
        <li class="nav-item mega-dropdown {{ $activeClass }}">
          <a href="javascript:;" class="nav-link dropdown-toggle navbar-ex-14-mega-dropdown mega-dropdown fw-medium" aria-expanded="false" data-bs-toggle="mega-dropdown" data-trigger="hover">
            <span>Pages</span>
          </a>
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-4 d-none d-lg-block">
                <div class="bg-body nav-img-col p-2">
                  <img src="{{asset('') }}" class="img-fluid scaleX-n1-rtl w-100" alt="nav item col image" data-app-light-img="front-pages/misc/nav-item-col-img-light.png" data-app-dark-img="front-pages/misc/nav-item-col-img-dark.png" />
                </div>
              </div>
            </div>
          </div>
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
      ...
      <li class="nav-item dropdown-style-switcher dropdown me-2 me-xl-0">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
          <li>
            <a class="dropdown-item" href="javascript:;" data-theme="light">
              <span class="align-middle"><i class='mdi mdi-weather-sunny me-2'></i>Light</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="javascript:;" data-theme="dark">
              <span class="align-middle"><i class="mdi mdi-weather-night me-2"></i>Dark</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="javascript:;" data-theme="system">
