...
$(function () {
  ...
  var dt_Client_table = $('.datatables-Clients'),
    select2 = $('.select2'),
    ClientView = baseUrl + 'app/ecommerce/Client/details/overview';
  if (select2.length) {
    var $this = select2;
    select2Focus($this);
  ...
  if (dt_Client_table.length) {
    var dt_Client = dt_Client_table.DataTable({
      ajax: assetsPath + 'json/ecommerce-Client-all.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              '<div class="d-flex justify-content-start align-items-center Client-country">' +
              '<div>' +
              $output_code +
              '</div>' +
              '<div>' +
      ...
      buttons: [
        ...
        {
          text: '<i class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Client</span>',
          className: 'add-new btn btn-primary ms-n1 waves-effect waves-light',
          attr: {
            'data-bs-toggle': 'offcanvas',
            'data-bs-target': '#offcanvasEcommerceClientAdd'
          }
        }
      ],
...
(function () {
  const phoneMaskList = document.querySelectorAll('.phone-mask'),
    eCommerceClientAddForm = document.getElementById('eCommerceClientAddForm');
  ...
  const fv = FormValidation.formValidation(eCommerceClientAddForm, {
    fields: {
      ClientName: {
        validators: {
          notEmpty: {
