            ...
            <div class="col-lg-12">
              <table class="table align-middle table-row-dashed table-striped table-hover gy-0 gs-1 list_page">
                ...
                <tbody class="text-black fw-semibold fs-7">
                  <tr>
                    <td>
                      <label class="text-black fw-medium fs-7">V1106</label>  
                    ...
                    <td>
                      <span class="text-end">
                        <a href="#" class="btn btn-icon btn-sm me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_room">
                          <span data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
                            <i class="mdi mdi-pencil-outline fs-3 text-black"></i>
                          </span>
                        </a>
                        <a href="#" class="btn btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_room">
                  ...
                  <tr>
                    <td>
                      <label class="text-black fw-medium fs-7">V2650</label>  
                      <a href="javascipt:;" data-bs-toggle="tooltip" data-bs-placement="right" title="-"><i class="mdi mdi mdi-help-circle text-dark"></i></a>
                    </td>
                    <td>
                    ...
                    <td>
                      <label class="text-black fw-medium fs-7">OOG-SHSP</label>  
                    </td>
                    <td>
                      <label class="switch switch-square">
                        <input type="checkbox" class="switch-input" checked />
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content rounded">
        ...
        <div class="modal-footer pt-5">
          <div class="d-flex justify-content-end align-items-center">
            <button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Create Room</button>
          </div>
        </div>
        <!--end::Modal body-->
      </div>
...
<div class="modal fade" id="kt_modal_edit_room" tabindex="-1" aria-hidden="true" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content rounded">
        <!--begin::Modal header-->
        <div class="modal-header d-flex align-items-center justify-content-between pb-0 border-bottom">
          <h4 class="text-center text-black">Update Room</h4>
          <!--begin::Close-->
          <div class="btn btn-sm btn-icon btn-active-color-primary mb-4" data-bs-dismiss="modal">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
        ...
        <div class="modal-footer pt-5">
          <div class="d-flex justify-content-end align-items-center">
            <button type="reset" class="btn btn-secondary me-3" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Update Room</button>
          </div>
        </div>
        <!--end::Modal body-->
      </div>
...
<!--begin::Modal - Delete Room-->
<div class="modal fade pt-20" id="kt_modal_delete_room" tabindex="-1" aria-hidden="true" aria-hidden="true" data-bs-keyboard="false" data-bs-backdrop="static">
  <!--begin::Modal dialog-->
  <div class="modal-dialog modal-m">
    ...
    <div class="modal-content rounded">
      ...
      <div class="swal2-html-container" id="swal2-html-container" style="display: block;">Are you sure you want to delete Room ?
        <div class="d-block fw-bold fs-5 py-2">
          <label class="text-danger">V1106</label>
        </div>
      </div>
